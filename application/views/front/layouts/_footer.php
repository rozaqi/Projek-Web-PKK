      ...
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               <div class="f_title">
                  <h3>ITEnthusiast.com</h3>
               </div>
               <p>IT Enthusiast adalah sebuah web yang berisikan informasi, tutorial, berita mengenail Internet Teknologi, Cyber Security, Cloud Computing, dan DevOps.</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
